  ...
  const getPFsById = async (uuid) => { // Terima uuid sebagai argumen
    try {
      ...
      if (response.status === 200) {
        ...
        setUnitpelayanan(pf.unitpelayanan);
        setKeluhanutama(pf.keluhanutama);
        setKeluhantambahan(pf.keluhantambahan);
        setRiwayatpenyakitsekarang(pf.riwayatpenyakitsekarang);
        setRiwayatpenyakitdahulu(pf.riwayatpenyakitdahulu);
        setRiwayatpenyakitkeluarga(pf.riwayatpenyakitkeluarga);
        setRiwayatalergi(pf.riwayatalergi);
        setTerapiyangpernahdijalani(pf.terapiyangpernahdijalani);
        setObatnyangseringdigunakan(pf.obatnyangseringdigunakan);
        setObatyangsedangdikonsumsi(pf.obatyangsedangdikonsumsi);
        setKeadaanumum(pf.keadaanumum);
        setKesadaranGCS(pf.kesadaranGCS);
        setTekanandarah(pf.tekanandarah);
        setNadi(pf.nadi);
        setSuhu(pf.suhu);
        setFreknafas(pf.freknafas);
        setBeratbadan(pf.beratbadan);
        setTinggibadan(pf.tinggibadan);
        setImtBBTB(pf.imtBBTB);
        setKepala(pf.kepala);
        setThorax(pf.thorax);
        setAbdormen(pf.abdormen);
        setEkstremitas(pf.ekstremitas);
        setLainnya(pf.lainnya);
        setStatusmental(pf.statusmental);
        setResponemosi(pf.responemosi);
        setHubunganpasiendengankeluarga(pf.hubunganpasiendengankeluarga);
        setKetaatanmenjalaniibadah(pf.ketaatanmenjalaniibadah);
        setBahasa(pf.bahasa);
      }
    } catch (error) {
